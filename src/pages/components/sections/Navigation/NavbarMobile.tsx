    ...
    <section className="flex-1">
      {open && (
        <section className="fixed inset-0 z-50 flex">
          <section className="w-64 bg-blue-200 shadow-lg h-full flex flex-col">
            ...
            <nav className="flex-1 space-y-1 px-4 py-2  overflow-y-auto bg-blue-50">
              {navItems.map((item) => (
                <NavLink
                  key={item.href}
                  to={item.href}
            ...
            <section className="flex flex-col">
              {isAuthenticated ? (
                <section className="p-4 border-t space-y-2">
                  <a
                    href="/perfil"
                    className="w-full justify-start gap-2 flex items-center p-2 rounded-lg hover:bg-blue-600 hover:border-blue-800 hover:text-white"
                  >
