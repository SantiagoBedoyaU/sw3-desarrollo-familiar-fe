          ...
          <section className='flex flex-wrap gap-2 items-center justify-evenly'>
            {changeableAuthors.map((author) => (
              <button
                ...
                onClick={() => {
                  setChangeableAuthors(changeableAuthors.filter((a) => a !== author))
                }}>
            ...
            <button
              ...
              onClick={(e) => {
                ...
                const uniqueKeywords = allKeywords.filter(
                  (keyword) =>
                    !changeableKeywords.includes(keyword) && keyword.trim() !== ''
                )
                setChangeableKeywords([...changeableKeywords, ...uniqueKeywords])
                setKeywords('')
              }}>
              <Plus size={16} />
              <span>Agregar</span>
