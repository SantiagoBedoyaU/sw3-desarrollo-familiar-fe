    ...
    <>
          ...
          <DialogHeader>
            <section className="flex justify-between items-center">
              ...
              {canEdit && (
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 p-2 border rounded-lg text-white bg-green-500 border-gray-50 hover:bg-green-600 hover:border-gray-800"
                  onClick={() => {
                    setOpen(false)
                    setOpenEdit(true)
                  }}
                >
                  <span><Edit size={16} className="w-4 h-4" /></span>
      ...
      {openEdit && (
        <Modal isOpen={openEdit} onClose={() => setOpenEdit(false)}>
          <div className="bg-white rounded-lg p-4 w-full max-w-4xl max-h-screen overflow-auto">
            <h2 className="text-xl font-bold mb-4">Editar Informe de Práctica</h2>
            <PracticeReportEdit
              practiceReport={practiceReport}
              onClose={() => {
